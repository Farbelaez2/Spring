			...
			<div class="signin-form profile">
				...
				<div class="login-form">
					<form action="personaEditarForm2.htm" method="post">    
                                            <h4><input type="number" name="identificacion" placeholder="Identificación" nkeypress="return validaNumero(event)" onpaste="return false" pattern="{8,10}" required="" value="${listaPersonas.get(0).getIdentificacion()}" readonly="readonly"></h4>
                                            <h4><input type="text" name="nombre1" placeholder="Nombre 1" onkeypress="return validaTexto(event)"  onpaste="return false" maxlength="20" minlength="3" required value="${listaPersonas.get(0).getNombre1()}"></h4>
                                            <h4><input type="text" name="nombre2" placeholder="Nombre 2" onkeypress="return validaTexto(event)"  onpaste="return false" maxlength="20" minlength="3" required value="${listaPersonas.get(0).getNombre2()}"></h4>
                                            <h4><input type="text" name="apellido1" placeholder="Apellido 1" onkeypress="return validaTexto(event)"  onpaste="return false" maxlength="20" minlength="3" required value="${listaPersonas.get(0).getApellido1()}"></h4>
                                            <h4><input type="text" name="apellido2" placeholder="Apellido 2" onkeypress="return validaTexto(event)"  onpaste="return false" maxlength="20" minlength="3" required value="${listaPersonas.get(0).getApellido2()}"></h4>
                                            <h4><select id="genero" name="genero" type="text" required value="${listaPersonas.get(0).getGenero()}">
						<option value="" disabled selected>Genero</option>
						<option value="M">Masculino</option>
						<option value="F">Femenino</option>
                                                <option value="O">Otro</option>
                                                </select></h4>
                                            <h4><select id="tipop" name="tipop" type="text"required value="${listaPersonas.get(0).getTipoP()}">
						<option value="" disabled selected>Tipo persona</option>
						<option value="1">1</option>
						<option value="2">2</option>
                                                </select></h4>
                                            <h4><input type="date" name="fecha" placeholder="Fecha Nacimiento" required="" value="${listaPersonas.get(0).getfNacimiento()}"></h4>
                                            <h4><input type="number" name="telefono" placeholder="Telefono" pattern ="{10}" required value="${listaPersonas.get(0).getTelef()}"></h4>
                                            <h4><input type="email" name="email" placeholder="E-mail" required="" value="${listaPersonas.get(0).getEmail()}"></h4>
